...
const wordAnimation = new _modules_word_animation__WEBPACK_IMPORTED_MODULE_10__["default"](".intro__title", ".screen--intro");
wordAnimation.init();

const wordAnimation2 = new _modules_word_animation__WEBPACK_IMPORTED_MODULE_10__["default"](".intro__label", ".screen--intro");
wordAnimation2.init();

const wordAnimation3 = new _modules_word_animation__WEBPACK_IMPORTED_MODULE_10__["default"](".slider__item-title", ".screen--story");
wordAnimation3.init();

const wordAnimation4 = new _modules_word_animation__WEBPACK_IMPORTED_MODULE_10__["default"](".prizes__title", ".screen--prizes");
wordAnimation4.init();
